...
public class Lobby extends BasicMessage {
	...
	private final String[] messages = {
			"Hola, Soy Happy 🤖 el asistente virtual de Be Okay 🍃..." + "\ue008\ue007\ue008¿Como te puedo ayudar?"
					+ "\ue008\ue007\ue0080️⃣ Quiénes somos" + "\ue008\ue007\ue0081️⃣ Información de nuestros productos"
					+ "\ue008\ue007\ue0082️⃣ Comprar" + "\ue008\ue007\ue0083️⃣ Otros",
			"0️⃣ Quiénes somos" + "\ue008\ue007\ue0081️⃣ Información de nuestros productos"
					+ "\ue008\ue007\ue0082️⃣ Comprar" + "\ue008\ue007\ue0083️⃣ Otros",
			...
			"0️⃣ Proteínas vegetales" + "\ue008\ue007\ue0081️⃣ Aderezos",
			"0️⃣ Definición general" + "\ue008\ue007\ue0081️⃣ Nutrientes" + "\ue008\ue007\ue0082️⃣ Modo de preparación",
			"0️⃣ Definición general" + "\ue008\ue007\ue0081️⃣ Nutrientes" + "\ue008\ue007\ue0082️⃣ Modo de uso",
			...
			"En nuestro Instagram encontrarás el paso a paso para preparar las proteínas 🤗 "
					+ "\ue008\ue007\ue008https://www.instagram.com/beokay.shop/?hl=es-la"
					+ "\ue008\ue007\ue008🤖Pronto regresaremos a nuestro menu principal...",
	...
	public BasicMessage messageResponse(int index) {
		...
		if (response != null && !response.isEmpty()) {
			...
			case 0:
				switch (response) {
				case "0": // Quienes somos
					msgResponse = new Lobby(phone, 2);
					ChatQueue.setPending(index, true);
					break;
				case "1": // Informacion productos
